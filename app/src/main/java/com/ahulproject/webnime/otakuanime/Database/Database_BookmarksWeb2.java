...
public class Database_BookmarksWeb2 extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION=1;
    private static final String DATABASE_NAME="bookmarks2.db";
    public static final String TABLE_BOOKMARK="bookmarks";
    public static final String COLUMN_ID="_id";
    public static final String COLUMN_NAME="url";

    public Database_BookmarksWeb2(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
