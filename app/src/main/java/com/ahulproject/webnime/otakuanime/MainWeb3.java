...
public class MainWeb3 extends AppCompatActivity {
    ...
    WebView webView;
    Database_HistoryWeb3 dbHandler_3;
    Database_BookmarksWeb3 dbHandlerbook_3;
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        //getSupportActionBar().setTitle("Gonunime");
        setContentView(R.layout.activity_main_web3);

        /***
        // custom toolbar
        toolbar = (Toolbar)findViewById(R.id.toolbarCustom_web3);
        setSupportActionBar(toolbar);
         ***/

        // Open Window Gonumine Web
        webView = (WebView)findViewById(R.id.gomunime_web);
        // Refresh Layout
        ...
        // History Database
        dbHandler_3 = new com.ahulproject.webnime.otakuanime.Database.Database_HistoryWeb3(this, null, null, 1);
        // Bookmarks Database
        dbHandlerbook_3 = new com.ahulproject.webnime.otakuanime.Database.Database_BookmarksWeb3(this,null,null,1);

        // Open Url
        webView.loadUrl("https://gomunime.com/#");
        ...
        webView.setWebViewClient(new MainWeb3.myWebclient());
        webView.setWebChromeClient(new MainWeb3.myChrome());
        webView.getSettings().setSupportZoom(true);
        webView.getSettings().setDisplayZoomControls(false);
        webView.getSettings().setBuiltInZoomControls(true);

        // Program History
        if(getIntent().getStringExtra("urls3") !=null){
            webView.loadUrl(getIntent().getStringExtra("urls3"));
        }
        // Download files
            ...
            public void onDownloadStart(String url, String useragent, String contentdisposition, String mimetype, long contentlenght)
            {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N_MR1){
                    if (checkSelfPermission(android.Manifest.permission.WRITE_EXTERNAL_STORAGE) == PackageManager.PERMISSION_GRANTED){
                        ...
                        ActivityCompat.requestPermissions(MainWeb3.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE},1);
                    }
                }
        ...
        bottomNav.setSelectedItemId(R.id.gomunime_nav);
        ...
        navigationView.addSpaceItem(new SpaceItem("Samehadaku", R.drawable.ic_baseline_web_1));
        navigationView.addSpaceItem(new SpaceItem("Anoboy", R.drawable.ic_baseline_web_2));
        ...
        navigationView.setSpaceOnLongClickListener(new SpaceOnLongClickListener() {
            ...
            public void onCentreButtonLongClick() {
                onBookPressed();
                Toast toast1 = Toast.makeText(MainWeb3.this, "Halaman ditambah ke bookmarks...",Toast.LENGTH_SHORT);
                toast1.setGravity(Gravity.CENTER,0,0);
                Toast toast2 = Toast.makeText(MainWeb3.this, "Pendam sekali lagi untuk penyimpanan pertama kali",Toast.LENGTH_SHORT);
            ...
            public void onItemLongClick(int itemIndex, String itemName) {
                if (desktopModeValue==0){
                    Toast toast = Toast.makeText(MainWeb3.this, "Mode Desktop On",Toast.LENGTH_SHORT);
                    toast.show();
                    desktopMode(webView, true);
                    desktopModeValue=1;
                }
                else{
                    Toast toast = Toast.makeText(MainWeb3.this, "Mode Desktop Off",Toast.LENGTH_SHORT);
                    toast.show();
        ...
        btnbookmarks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view){
                onBookPressed();
                Toast.makeText(MainWeb3.this, "Halaman ditambah ke bookmarks", Toast.LENGTH_SHORT).show();
            }
        });
         ***/
    ...
    public boolean onOptionsItemSelected(MenuItem item){
        ...
        if (id == R.id.forward_item1){
            ...
            Intent historyIntent = new Intent(MainWeb3.this, HistoryWeb3.class);
            startActivity(historyIntent);

        }
        else if (id == R.id.bookmarks_item5){
            Intent bookmarksIntent = new Intent(MainWeb3.this, BookmarksWeb3.class);
            ...
            Toast toast1 = Toast.makeText(MainWeb3.this, "Halaman ditambah ke bookmarks...",Toast.LENGTH_SHORT);
            toast1.setGravity(Gravity.CENTER,0,0);
            Toast toast2 = Toast.makeText(MainWeb3.this, "Tekan sekali lagi untuk penyimpanan pertama kali",Toast.LENGTH_SHORT);
            //toast2.setGravity(Gravity.BOTTOM,0,0);
            toast1.show();
            toast2.show();
        }
