...
public class Database_HistoryWeb2 extends SQLiteOpenHelper {

    private static final int DATABASE_VERSION=1;
    private static final String DATABASE_NAME="sites2.db"; // name of file database
    public static final String TABLE_SITES="sites"; // name of table
    public static final String COLUMN_ID="_id";
    public static final String COLUMN_URL="url";

    public Database_HistoryWeb2(@Nullable Context context, @Nullable String name, @Nullable SQLiteDatabase.CursorFactory factory, int version) {
    ...
    public void deleteUrl(String urlName){
        SQLiteDatabase sqlite=getWritableDatabase();
        sqlite.execSQL("DELETE FROM " + TABLE_SITES + " WHERE "+COLUMN_URL+"=\";"+urlName +"=\";" );
    }
